...
public class ReminderAdapater extends RecyclerView.Adapter<ReminderAdapater.MyViewHolder> {
    ...
    public ReminderAdapater (Context c, ArrayList<String> name,ArrayList<String> am_or_pm,ArrayList<String> hour,
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, final int position) {
        ...
        holder.alarm_on_or_off.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (ReminderFragment.alarm_activated.get(position).equals(true)){
                    ReminderFragment.alarm_activated.set(position,false);
                    System.out.println((position+1) + "  off");

                }
                else if (ReminderFragment.alarm_activated.get(position).equals(false)){
                    ReminderFragment.alarm_activated.set(position,true);
                ...
                new AlertDialog.Builder(c)
                        ...
                        .setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int whichButton) {
                                ...
                                ReminderFragment.alarm_activated.remove(position);
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder{
        ...
        public MyViewHolder(@NonNull View itemView) {
            super(itemView);
            alarm_AM_or_PM = itemView.findViewById(R.id.alarm_AM_or_PM);
            alarm_time = itemView.findViewById(R.id.alarm_time);
            alarm_name = itemView.findViewById(R.id.alarm_name);
            alarm_on_or_off = itemView.findViewById(R.id.alarm_on_or_off);
